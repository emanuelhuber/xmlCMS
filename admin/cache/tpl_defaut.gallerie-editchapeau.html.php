...
<div id="principal_large">
	<div id="wrapper">
		...
		<br/> -->
		<?php if ($this->_rootref['IS_ONLINE']) {  ?>
			 Retirer la gallerie &nbsp;<span><a href="<?php echo (isset($this->_rootref['LINK_PUBLISH'])) ? $this->_rootref['LINK_PUBLISH'] : ''; ?>" title="Retirer la gallerie"><img src="design/defaut/images/offline.png" alt="Retirer la gallerie"/></a></span>
		<?php } else { ?>
		 Mettre la gallerie en ligne &nbsp;<span><a href="<?php echo (isset($this->_rootref['LINK_PUBLISH'])) ? $this->_rootref['LINK_PUBLISH'] : ''; ?>" title="Publier l'gallerie"><img src="design/defaut/images/online.png" alt="Publier la gallerie"/></a></span>
		<?php } ?>
		</p>
		...
		<ul class="tabs">
			...
			<li class="selected"><a href="<?php echo (isset($this->_rootref['LINK_EDITCHAPEAU'])) ? $this->_rootref['LINK_EDITCHAPEAU'] : ''; ?>">Editer Chapeau</a></li>
			<li><a href="<?php echo (isset($this->_rootref['LINK_EDITINFO_ARTICLE'])) ? $this->_rootref['LINK_EDITINFO_ARTICLE'] : ''; ?>">Editer Infos Gallerie</a></li>
		</ul>
		<div id="petitframe">		
