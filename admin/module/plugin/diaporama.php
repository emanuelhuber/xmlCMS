...
class ModulePluginDiaporama extends ModuleAdmin{
protected $_plugin = '';
	...
	public function setData(){
		...
		self::$arrayToParse['LINK_INDEX'] = $this->urlAddQuery(array(),true);
		self::$arrayToParse['LINK_ADD_DIA'] = $this->urlAddQuery(array( 'action'=>'ad'),true);
		self::$arrayToParse['LINK_DELETE'] =$this->urlAddQuery(array(),true);
