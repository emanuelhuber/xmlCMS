...
<div id="principal">
	...
	<div id="wrapper">
	   <ul class="tabs">
			...
			<li class="selected"><a href="<?php echo (isset($this->_rootref['LINK_ADD_GROUP'])) ? $this->_rootref['LINK_ADD_GROUP'] : ''; ?>" title="Ajouter un groupe">Ajouter un groupe</a></li>
		</ul>
		<form class="edit" name="editinfo" method="POST" action="<?php echo (isset($this->_rootref['FICHIER_CIBLE'])) ? $this->_rootref['FICHIER_CIBLE'] : ''; ?>">
			...
			<fieldset class="metadonnees">
				...
				<label>Nom :<input type="text" name="name" value="<?php echo (isset($this->_rootref['GRP_NAME'])) ? $this->_rootref['GRP_NAME'] : ''; ?>" size="18" maxlength="50"/></label>
				<label>Description :<input type="text" name="description" value="<?php echo (isset($this->_rootref['GRP_DESCRIPTION'])) ? $this->_rootref['GRP_DESCRIPTION'] : ''; ?>" size="40" maxlength="50"/></label>
			</fieldset>
