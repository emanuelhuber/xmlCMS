...
<div id="principal">	
	...
	<div id="wrapper">
	   ...
	   <ul class="tabs">
			<li><a href="<?php echo (isset($this->_rootref['LINK_EDITCONTENT_ARTICLE'])) ? $this->_rootref['LINK_EDITCONTENT_ARTICLE'] : ''; ?>">Editer article</a></li>
			<li class="selected"><a href="<?php echo (isset($this->_rootref['LINK_EDITINFO_ARTICLE'])) ? $this->_rootref['LINK_EDITINFO_ARTICLE'] : ''; ?>">Editer info article</a></li>
		</ul>
