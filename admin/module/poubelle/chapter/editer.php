...
class ModuleChapterEditer extends ModuleAdmin{
	...
	public function editMenuChap($path,$id){
		...
		self::$arrayToParse['CURRENT_CRUMB'] = 'Chaptire : '.self::$arrayToParse['FORM_TITRE'];
	}
