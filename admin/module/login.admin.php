<?php
class ModuleAdminLogin extends ModuleAdmin{
	...
	public function __construct($url, $query, $urlArray, $conf){
		...
		$path = BASE_PATH.$this->_config['path']['data'].$urlArray[1].'/'.$urlArray[2].$this->_config['ext']['data'];
		 self::$myPage = new Xml_User($urlArray, $root="base");
		// $this -> echo_r(self::$myPage -> getDesign());
		/* echo ROOT_PATH.$this->_config['librairie']['interstitium'].'users.class.php';
		echo '<br/>'; */
	}
