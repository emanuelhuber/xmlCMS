    ...
    jQuery('.wymeditor').wymeditor({
       ...
       // html: '<p>Hello, World!<\/p>', //set editor's value
		...
		// BUTTON SPECIAL CHARACTERS
			...
			var html = "<div class='symbolSelector' style='position: absolute;display: none;width: 100px;background:white;border:1px solid black;font-size:15px;margin:4px;'><span>£</span><span> sdf€ </span></div>";
