...
<div id="principal">	
	...
	<div id="wrapper">
	   ...
	   <ul class="tabs">
			...
			<li class="selected"><a href="<?php echo (isset($this->_rootref['LINK_EDITINFO'])) ? $this->_rootref['LINK_EDITINFO'] : ''; ?>">Editer les métadonnées</a></li>
		...
		<form class="edit" name="editinfo" method="POST" action="<?php echo (isset($this->_rootref['FICHIER_CIBLE'])) ? $this->_rootref['FICHIER_CIBLE'] : ''; ?>#tab1">
			...
			<fieldset class="metadonnees">
				...
				<p> <label> Nombres d'articles à afficher par page
				<input type="text" name="option[nb]" value="<?php echo (isset($this->_rootref['OPTION_NB'])) ? $this->_rootref['OPTION_NB'] : ''; ?>" size="3" maxlength="3"/></label></p>
